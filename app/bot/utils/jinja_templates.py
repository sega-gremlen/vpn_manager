...
/info для более подробной информации о проекте
""")
...
info_tm = """
• Проект направлен исключительно для обеспечения приватности и безопасности пользователей в интернете и не предназначен для какой-либо преступной деятельности

• Проект построен прокси-протоколе, который благодаря своим продвинутым методам шифрования и маскировки, остаётся неуловимым для современных систем блокировки в Китае, Иране, Туркменистане.

• Проект не хранит никаких ваших данных, кроме telegram id

• Прокси-сервер расположен в Нидерландах (Амстердам)
