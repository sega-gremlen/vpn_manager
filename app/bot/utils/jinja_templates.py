...
🤫 Устойчивость к любым блокировкам
🚀 Без ограничения по скорости
💳 Оплата через сервис электронных платежей Юmoney
🌐 Сохранение доступа к сервисам в РФ с включенным VPN
...
• Количество устройств, которые вы можете подключить по вашей ключ-ссылке не ограничено
• Действует лимит трафика 200 гигабайт в месяц
• Вы в любой момент можете посмотреть вашу ключ-ссылку и текущий расход трафика в вашем профиле в главном меню бота
"""
...
info_tm = """
• Проект направлен исключительно на обеспечение приватности и безопасности пользователей в интернете и не предназначен для использования в преступной деятельности.

• Проект основан на прокси-протоколе, который благодаря продвинутым методам шифрования и маскировки остаётся неуловимым для современных систем блокировки в Китае, Иране и Туркменистане.

• Проект не хранит никаких ваших данных, кроме вашего Telegram ID.

• Прокси-сервер расположен в Амстердаме, Нидерланды.

• Количество устройств, которые вы можете подключить по вашей ключ-ссылке, не ограничено.

• Лимит трафика составляет 200 гигабайт в месяц.

• Вы в любой момент можете посмотреть вашу ключ-ссылку и текущий расход трафика в профиле, доступном в главном меню бота.
"""
